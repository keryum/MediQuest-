...
class BiochemistryPage extends StatefulWidget {
  BiochemistryPage({super.key});

  final playerController = Get.find<PlayerController>();

  @override
  State<BiochemistryPage> createState() => _BiochemistryPageState();
}

class _BiochemistryPageState extends State<BiochemistryPage> {
  @override
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return Obx(() {
              bool isUnlocked = biochemistryQuestions[index].idQuestion <=
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuestionsPage(
                          idQuestion:
                              biochemistryQuestions[selectedLevel].idQuestion,
                        ),
                      ),
                    );
                ...
                child: Stack(
                  children: [
                    Container(
                      ...
                      child: Text(
                        biochemistryQuestions[index].idQuestion.toString(),
